...
def loadmlibrary(env) :
	...
	## includes
	mincs = ['options', 'translationTable', 'splash', 'gruns', 'textProgressBar', 'gstring', 'frequencySyncSignal', 'qtButtonsWidget', 'gfactory', 'gvolume', 'g4volume', 'g4display', 'gtouchable', 'gdynamic']
	mincludes = []
	for minc in mincs:
